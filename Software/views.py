...
def Man_previousstaffProfile(request):
    return render(request,'Man_previousstaffProfile.html')

def Manager_previousstudentprofile(request):
    return render(request,'Manager_previousstudentprofile.html')
...
#**************************************Account module*****************************************
#**************************************     Praveen   ****************************************
def Accounts_accsetting(request):
    return render(request,'Accounts_accsetting.html')

def Accounts_accsettingimagechange(request):
    return render(request, 'Accounts_accsettingimagechange.html')

def Accounts_changepwd(request):
    return render(request, 'Accounts_changepwd.html')
...
def Acc_current_students(request):
     return render(request, 'Acc_current_students.html')

#*********************anwar & anandhu******************
def Account_staff(request):
        return render(request,'Account_staff.html')
        
def Account_staffprevious(request):
    return render(request,'Account_staffprevious.html')

#*********************nimisha & meenu******************

def Accounts_CurrentStaff(request):     
    return render(request,'Accounts_CurrentStaff.html')

def Accounts_CurrentStaffAddaccount(request):     
    return render(request,'Accounts_CurrentStaffAddaccount.html')

def Accounts_CurrentStaffpayslip(request):     
    return render(request,'accounts_payslip.html')

def Accounts_CurrentStaffpayslipdetails(request):     
    return render(request,'accounts_paydetails.html')

def Accounts_CurrentStaffpaymentdetails(request):     
    return render(request,'account_payment_details.html')

def Accounts_CurrentStaffpaymentsalary(request):     
    return render(request,'account_payment_salary.html')

def Accounts_CurrentStaffpaymentview(request):     
    return render(request,'account_payment_view.html')

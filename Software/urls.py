...
urlpatterns = [
    ...
    re_path(r'^Managerlogout$', views.Managerlogout, name='Managerlogout'),
    re_path(r'^Stafflogout$', views.Stafflogout, name='Stafflogout'),
    re_path(r'^Studentlogout$', views.Studentlogout, name='Studentlogout'),
    re_path(r'^Accountslogout$', views.Accountslogout, name='Accountslogout'),
    ...
    re_path(r'^Man_previousstaffProfile$', views.Man_previousstaffProfile,name='Man_previousstaffProfile'),
    re_path(r'^Manager_previousstudentprofile$', views.Manager_previousstudentprofile,name='Manager_previousstudentprofile'),
...
#**************************************Account module*****************************************
#**************************************     sharon & subeesh   ****************************************
    re_path(r'^Accounts_accsetting/$', views.Accounts_accsetting, name='Accounts_accsetting'),
    re_path(r'^Accounts_accsettingimagechange/$', views.Accounts_accsettingimagechange, name='Accounts_accsettingimagechange'),
    re_path(r'^Accounts_changepwd/$', views.Accounts_changepwd, name='Accounts_changepwd'),
    ...
    re_path(r'^Account_staff/$', views.Account_staff, name='Account_staff'),
...
#**********************nimisha & meenu************************
    ...
    re_path(r'^Accounts_CurrentStaffAddaccount$', views.Accounts_CurrentStaffAddaccount, name='Accounts_CurrentStaffAddaccount'),
    re_path(r'^Accounts_CurrentStaffpayslip$', views.Accounts_CurrentStaffpayslip, name='Accounts_CurrentStaffpayslip'),
    re_path(r'^Accounts_CurrentStaffpayslipdetails$', views.Accounts_CurrentStaffpayslipdetails, name='Accounts_CurrentStaffpayslipdetails'),
    re_path(r'^Accounts_CurrentStaffpaymentdetails$', views.Accounts_CurrentStaffpaymentdetails, name='Accounts_CurrentStaffpaymentdetails'),
    re_path(r'^Accounts_CurrentStaffpaymentsalary$', views.Accounts_CurrentStaffpaymentsalary, name='Accounts_CurrentStaffpaymentsalary'),
    re_path(r'^Accounts_CurrentStaffpaymentview$', views.Accounts_CurrentStaffpaymentview, name='Accounts_CurrentStaffpaymentview'),
